...
<section id="content">
		   ...
		   <li>
		    ...
		    <div class="thumb">
		     <img src="https://anjoimages.s3.amazonaws.com/${cartList.pdimg1}" />
		    </div>
		    <div class="gdsInfo">
		     <p>
		      <span>상품명 ${cartList.pdname}<br />
		      <span>개당 가격 ${cartList.pdprice}원<br />		      
		      <span>구입 수량 ${cartList.ctcnt} 개<br />
		      <span>최종 가격 ${cartList.pdprice}원
		     </p>
		     
		     <div class="delete">
		      <button type="button" class="delete_${cartList.cartnum} btn" data-cartNum="${cartList.cartnum}">삭제</button>
