...
<h3>게시물</h3>
	...
	<div class="input_wrap">
		<label>게시판 작성자</label>
		<input name="nwriter" readonly="readonly" value='<c:out value="${pageInfo.nwriter}"/>' >
	</div>
	<div class="input_wrap">
		<label>게시판 등록일</label>
		<input name="ndate" readonly="readonly" value='<fmt:formatDate pattern="yyyy/MM/dd" value="${pageInfo.ndate}"/>' >
	</div>
	<div class="input_wrap">
		<label>게시판 수정일</label>
		<input name="nupdate" readonly="readonly" value='<fmt:formatDate pattern="yyyy/MM/dd" value="${pageInfo.nupdate}"/>' >
	</div>		
	<div class="btn_wrap">
