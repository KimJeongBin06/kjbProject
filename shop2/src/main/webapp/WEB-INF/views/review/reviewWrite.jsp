					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="single_blog_post clearfix" data-animated="fadeInUp">
							<div class="single_blog_post_descr">
								...
								<br>
								제목 : <div class="single_blog_post_title"><input type="text" name="revtitle" id="revtitle"></div>
								
								<ul class="single_blog_post_info">																
								</ul>
								상품명 : 
								<select name="pdnu" style="height:30px; width:500px; border-radius:10px">
									<c:forEach var="row" items="${list }">
										<option value="${row.pdnu }" style="text-align:center">${row.pdname }</option>
									</c:forEach>
								</select>
							</div>
							...
							<div class="single_blog_post_content">
								<p class="margbot50">
									본문 :
									<textarea rows="10" cols="50" name="revcontent" id="revcontent"></textarea>
								</p>
							</div>
						...
						<c:choose>
							...
							<c:otherwise>
								<input class="contact_btn pull-right" type="button" id="btnWrite" value="작성">	
							</c:otherwise>
						</c:choose>
